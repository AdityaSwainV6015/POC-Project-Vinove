...
import '../constants/deoationwideget.dart';
import '../message/chatmessage.dart';
...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen({Key? key, required this.name, required this.imagepath, imagePath})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            CircleAvatar(child: Image.asset(widget.imagepath)),
            SizedBox(
              width: 5,
            ),
            Text(widget.name),
