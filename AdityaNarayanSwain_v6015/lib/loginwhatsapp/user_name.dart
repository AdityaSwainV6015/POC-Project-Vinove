  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          "Profile info",
          style: TextStyle(color: AppColors.teal_dark_green,),
        ),
        elevation: 0.0,
        actions: <Widget>[
          IconButton(
            ...
            SizedBox( height: 200,
              child: Column(
                ...
                children: [
                  ...
                  Image.asset('images/camera.png', scale: 8, color: Colors.grey,),
                  Container(
            ...
            MyElevatedButton(
              onPressed: () {
                ...
                Navigator.push(context,
                    CupertinoPageRoute(builder: (context) => WhatsApp(title: 'WhatsApp')));
              },
              child: Text('Continue'),
            ),
          ],
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.teal_dark_green,
